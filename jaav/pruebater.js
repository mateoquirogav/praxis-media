...
(function(){
  if(window.JAAV_TERMICA_LANDING_MOUNTED) return;
  window.JAAV_TERMICA_LANDING_MOUNTED = true;

  var JAAV = {
    heroImg: "https://cdn.jsdelivr.net/gh/mateoquirogav/praxis-media@main/jaav/ter-negra.webp",
    negroImg: "https://cdn.jsdelivr.net/gh/mateoquirogav/praxis-media@main/jaav/ter-negra.webp",
    blancoImg: "https://cdn.jsdelivr.net/gh/mateoquirogav/praxis-media@main/jaav/ter-blanca.webp",
    talleImg: "https://cdn.jsdelivr.net/gh/mateoquirogav/praxis-media@main/jaav/ter-talles.png",

    tabs: {
      info: {
        gif: "https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExYXV6a3lrZzBqOWpvYzB1ZmE5bDMzeG1teGQ0NTUzZDhzZXJ1NW9saCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/gOH84jsH69SoUgtxMg/giphy.gif",
        titulo: "Abrigo liviano para moverte cómodo",
        texto: "Diseñada como primera piel para entrenar, trabajar o usar en invierno sin sentir peso de más."
      },
      contextura: {
        gif: "https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExemhkenY0NXpidTduZHdxdmxpZWQzM28zOXA0MGY3bmhwcTV6Z2NvNyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/mjiqsnwpSWP4flWrC0/giphy.gif",
        titulo: "Corte anatómico que se adapta al cuerpo",
        texto: "Acompaña la contextura sin restringir el movimiento. Ideal para usar debajo de otra prenda."
      },
      accion: {
        gif: "https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExaWozcTZzb3lxbzU1ZHE0MWh0cTB2ZThmdzBpbGdxcm03bXlkOWhyaCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/suBEfTe5YOtG4JcjP1/giphy.gif",
        titulo: "Para deporte, trabajo o uso urbano",
        texto: "Abriga, respira y seca rápido. Pensada para acompañarte en movimiento durante el invierno."
      }
    },

    testimonios: [
      { nombre:"Lucas", texto:"La uso para entrenar temprano y abriga sin hacerme transpirar de más.", stars:"★★★★★" },
      { nombre:"Martín", texto:"Muy cómoda debajo del buzo. No pica, no molesta y se siente liviana.", stars:"★★★★★" },
      { nombre:"Nico", texto:"Me gustó el calce porque queda al cuerpo pero no limita el movimiento.", stars:"★★★★☆" },
      { nombre:"Agustín", texto:"Compré el pack blanco y negro. Excelente para invierno y para trabajar.", stars:"★★★★★" }
    ]
  };

  function injectCSS(){
    if(document.getElementById("jaav-termica-css")) return;

    var css = `
      #jaavLanding{
        display:block!important;background:#050505!important;color:#f7f7f7!important;font-family:"DM Sans",Arial,sans-serif!important;
        overflow-x:hidden!important;overflow-y:visible!important;padding-bottom:110px!important;max-width:1180px!important;margin:0 auto!important;
      ...
      .jv-benefits-row{display:grid!important;grid-template-columns:1fr 1fr!important;gap:8px!important;margin:18px 0!important}
      .jv-benefit{background:rgba(255,255,255,.05)!important;border:1px solid rgba(255,255,255,.10)!important;border-radius:14px!important;padding:13px 11px!important;font-size:12px!important;font-weight:700!important;color:#fff!important;display:flex!important;align-items:center!important;gap:8px!important;animation:jvFloat 3.2s ease-in-out infinite!important;will-change:transform!important}
      .jv-benefit:nth-child(1){animation-delay:0s!important}.jv-benefit:nth-child(2){animation-delay:.6s!important}.jv-benefit:nth-child(3){animation-delay:1.2s!important}.jv-benefit:nth-child(4){animation-delay:1.8s!important}
      @keyframes jvFloat{0%,100%{transform:translateY(0px);box-shadow:0 4px 14px rgba(0,0,0,.28)}50%{transform:translateY(-5px);box-shadow:0 12px 22px rgba(0,0,0,.42)}}
      .jv-benefit i{width:20px!important;height:20px!important;border-radius:50%!important;background:#fff!important;color:#000!important;display:flex!important;align-items:center!important;justify-content:center!important;font-style:normal!important;font-size:11px!important;font-weight:950!important;flex-shrink:0!important}
      ...
      .jv-btn{display:flex!important;align-items:center!important;justify-content:center!important;width:100%!important;border:0!important;outline:0!important;border-radius:14px!important;background:linear-gradient(135deg,#4ade80,#22c55e)!important;color:#052e16!important;font-size:15px!important;font-weight:950!important;text-transform:uppercase!important;padding:16px 20px!important;cursor:pointer!important;text-decoration:none!important;letter-spacing:.05em!important;box-shadow:0 12px 28px rgba(74,222,128,.26)!important;transition:transform .2s, box-shadow .2s!important;-webkit-tap-highlight-color:transparent!important}
      ...
      .jv-hero-video img{width:100%!important;height:520px!important;object-fit:cover!important;object-position:center!important;display:block!important}
      ...
      .jv-demo img{width:100%!important;height:440px!important;object-fit:cover!important;object-position:center!important;display:block!important}
      ...
      .jv-product-grid{display:grid!important;grid-template-columns:1fr 1fr!important;gap:10px!important;margin-top:16px!important}
      .jv-product-card{background:#111!important;border:1px solid rgba(255,255,255,.09)!important;border-radius:18px!important;overflow:hidden!important}
      .jv-product-card img{width:100%!important;height:280px!important;object-fit:cover!important;object-position:center!important}
      .jv-product-card div{padding:12px!important}
      .jv-product-card strong{color:#fff!important;font-size:13px!important;display:block!important}
      .jv-product-card span{color:#999!important;font-size:11px!important}
      ...
      .jv-size-card{margin-top:18px!important;background:#fff!important;border-radius:20px!important;padding:14px!important}
      .jv-size-card img{width:100%!important;border-radius:14px!important}
      ...
      .jv-pack-includes{display:grid!important;grid-template-columns:repeat(2,1fr)!important;gap:7px!important}
      ...
      .jv-pack-item span{display:block!important;font-size:20px!important;margin-bottom:5px!important}
      .jv-pack-item strong{display:block!important;font-size:18px!important;font-weight:950!important;color:#fff!important}
      ...
      .jv-test{min-width:84%!important;scroll-snap-align:center!important;border-radius:16px!important;border:1px solid rgba(255,255,255,.09)!important;flex-shrink:0!important;background:#111!important;padding:18px!important}
      .jv-test .stars{color:#f6b800!important;letter-spacing:1px!important;font-size:14px!important;margin-bottom:10px!important;display:block!important}
      .jv-test p{font-size:14px!important;line-height:1.55!important;color:#d7d7d7!important;margin:0 0 14px!important}
      .jv-test strong{color:#fff!important;font-size:13px!important}
      ...
      .jv-sticky{position:fixed!important;left:50%!important;transform:translateX(-50%)!important;bottom:8px!important;z-index:99999!important;background:#fff!important;border:1px solid #e0e0e0!important;border-radius:16px!important;box-shadow:0 8px 32px rgba(0,0,0,.22)!important;padding:9px!important;display:flex!important;align-items:center!important;gap:9px!important;width:calc(100vw - 24px)!important;max-width:450px!important}
      ...
      @media(min-width:820px){
        ...
        #jaavLanding .jv-hero-video{margin-top:0!important;grid-column:2!important;grid-row:span 7!important}
        #jaavLanding .jv-hero-video img{height:620px!important}
        ...
        #jaavLanding .jv-features{grid-template-columns:repeat(3,1fr)!important}
        ...
        #jaavLanding .jv-product-card img{height:420px!important}
        #jaavLanding .jv-size-card{max-width:620px!important;margin-left:auto!important;margin-right:auto!important}
        #jaavLanding .jv-pack-final{max-width:720px!important;margin:0 auto!important}
      }
    `;

    var st = document.createElement("style");
    st.id = "jaav-termica-css";
    st.textContent = css;
  ...
  function buildHTML(){
    ...
    return '<div id="jaavLanding">'+
      ...
      '<section class="jv-hero">'+
        '<p class="jv-kicker">Pack x2 · Línea Deportiva</p>'+
        '<h1 class="jv-title">Camiseta térmica deportiva JAAV.</h1>'+
        '<div class="jv-rating"><span class="jv-stars">★★★★★</span><strong>Abrigo · Confort · Alto rendimiento</strong></div>'+
        '<p class="jv-text">La camiseta térmica JAAV está diseñada para ofrecer abrigo, confort y alto rendimiento. Ideal como primera piel para entrenamientos al aire libre, actividades laborales o uso urbano durante el invierno.</p>'+

        '<div class="jv-benefits-row">'+
          '<div class="jv-benefit"><i>✓</i>Interior afelpado</div>'+
          '<div class="jv-benefit"><i>✓</i>Tecnología Hidrowick®</div>'+
          '<div class="jv-benefit"><i>✓</i>Secado rápido</div>'+
          '<div class="jv-benefit"><i>✓</i>Corte anatómico</div>'+
        '</div>'+
        ...
        '<div class="jv-hero-video">'+
          '<img loading="eager" src="'+JAAV.heroImg+'" alt="Camiseta térmica deportiva JAAV negra">'+
          '<div class="jv-video-label"><strong>Pack x2 Camiseta térmica Art. 6000</strong><span>Incluye 1 negra + 1 blanca. Abrigo liviano para entrenar, trabajar o usar todos los días.</span></div>'+
        '</div>'+
      '</section>'+
      ...
      '<section class="jv-section jv-auth">'+
        '<div class="jv-auth-grid">'+
          '<div class="jv-auth-item"><strong>+150.000</strong><span>Prendas vendidas</span></div>'+
      ...
      '<section class="jv-section">'+
        ...
        '<h2 class="jv-title">El frío no debería frenarte.</h2>'+
        '<p class="jv-text">Para entrenar, trabajar o salir en invierno necesitás una prenda que abrigue sin incomodar.</p>'+
        '<div class="jv-problems">'+
          '<div class="jv-problem"><span>✕</span><strong>Prendas pesadas</strong><p>Abrigan, pero limitan el movimiento y se sienten incómodas.</p></div>'+
          '<div class="jv-problem"><span>✕</span><strong>Transpiración acumulada</strong><p>El cuerpo se humedece y terminás sintiéndote frío o incómodo.</p></div>'+
          '<div class="jv-problem"><span>✕</span><strong>Roce en la piel</strong><p>Las costuras comunes pueden molestar durante el uso prolongado.</p></div>'+
          '<div class="jv-problem"><span>✕</span><strong>Se deforma con lavados</strong><p>Muchas térmicas pierden forma o propiedades con el tiempo.</p></div>'+
        '</div>'+
        '<div class="jv-alert">Una buena térmica tiene que abrigar, respirar y moverse con vos.</div>'+
      '</section>'+

      '<section class="jv-section">'+
        '<p class="jv-kicker">En uso real</p>'+
        '<h2 class="jv-title">Así se siente puesta.</h2>'+
        '<p class="jv-text">Mirá cómo acompaña el cuerpo, el movimiento y el uso diario.</p>'+
        '<div class="jv-tabs">'+
        ...
        '</div>'+
        '<div class="jv-demo">'+
          '<img id="jvActionImg" loading="lazy" src="'+JAAV.tabs.info.gif+'" alt="Camiseta térmica JAAV en uso">'+
      ...
      '<section class="jv-section">'+
        '<p class="jv-kicker">Colores incluidos</p>'+
        '<h2 class="jv-title">Negra y blanca en el mismo pack.</h2>'+
        '<p class="jv-text">Dos colores básicos para combinar fácil durante el invierno.</p>'+
        '<div class="jv-product-grid">'+
          '<div class="jv-product-card"><img loading="lazy" src="'+JAAV.negroImg+'" alt="Camiseta térmica JAAV negra"><div><strong>Negra</strong><span>Ideal para entrenar, trabajar o usar debajo de otra prenda.</span></div></div>'+
          '<div class="jv-product-card"><img loading="lazy" src="'+JAAV.blancoImg+'" alt="Camiseta térmica JAAV blanca"><div><strong>Blanca</strong><span>Liviana, respirable y cómoda para el uso diario.</span></div></div>'+
        '</div>'+
      '</section>'+

      '<section class="jv-section">'+
        '<p class="jv-kicker">Tabla de talles</p>'+
        '<h2 class="jv-title">Elegí tu talle ideal.</h2>'+
        '<p class="jv-text">Usá la guía de talles para elegir el calce más cómodo según tu cuerpo.</p>'+
        '<div class="jv-size-card"><img loading="lazy" src="'+JAAV.talleImg+'" alt="Tabla de talles camiseta térmica deportiva JAAV"></div>'+
      '</section>'+

      '<section class="jv-section">'+
        '<p class="jv-kicker">Beneficios</p>'+
        '<h2 class="jv-title">Tecnología para el invierno.</h2>'+
        '<p class="jv-text">Pensada para mantener el calor corporal sin perder respirabilidad.</p>'+
        '<div class="jv-features">'+
          '<div class="jv-feature"><strong>Interior afelpado</strong><p>Aporta suavidad extra y mayor retención del calor corporal.</p></div>'+
          '<div class="jv-feature"><strong>Hidrowick®</strong><p>Favorece la evaporación de la transpiración para mantenerte seco y cómodo.</p></div>'+
          '<div class="jv-feature"><strong>Tejido liviano</strong><p>Respirable, cómodo y de secado rápido para uso deportivo o diario.</p></div>'+
          '<div class="jv-feature"><strong>Corte anatómico</strong><p>Se adapta al cuerpo sin restringir el movimiento.</p></div>'+
          '<div class="jv-feature"><strong>Costuras planas</strong><p>Ayudan a evitar roces o irritaciones durante el uso prolongado.</p></div>'+
          '<div class="jv-feature"><strong>Alta durabilidad</strong><p>No se deforma con los lavados ni pierde sus propiedades.</p></div>'+
        '</div>'+
      '</section>'+
      ...
      '<section class="jv-section">'+
        '<div class="jv-compare">'+
          ...
          '<div class="jv-row"><b>Térmica común</b><b>Térmica JAAV</b></div>'+
          '<div class="jv-row"><span class="jv-no">Pesada e incómoda</span><span class="jv-yes">Liviana y respirable</span></div>'+
          '<div class="jv-row"><span class="jv-no">Acumula humedad</span><span class="jv-yes">Tecnología Hidrowick®</span></div>'+
          '<div class="jv-row"><span class="jv-no">Molesta con el uso</span><span class="jv-yes">Costuras planas</span></div>'+
          '<div class="jv-row"><span class="jv-no">Pierde forma</span><span class="jv-yes">Alta durabilidad</span></div>'+
          '<div class="jv-row"><span class="jv-no">Limita movimiento</span><span class="jv-yes">Corte anatómico</span></div>'+
        '</div>'+
      '</section>'+

      '<section class="jv-section">'+
        '<div class="jv-pack-final">'+
          '<p class="jv-kicker">Pack x2</p>'+
          '<h2 class="jv-title">Camiseta térmica deportiva.</h2>'+
          '<p class="jv-text">Ideal como primera piel para entrenamientos al aire libre, actividades laborales o uso urbano durante el invierno.</p>'+
          '<div class="jv-pack-box">'+
            '<h3>Pack x2 Art. 6000</h3>'+
            '<p>Línea Deportiva JAAV. Abrigo, confort y rendimiento en un pack práctico.</p>'+
            '<div class="jv-pack-includes">'+
              '<div class="jv-pack-item"><span>⚫</span><strong>1</strong><small>Negra</small></div>'+
              '<div class="jv-pack-item"><span>⚪</span><strong>1</strong><small>Blanca</small></div>'+
            '</div>'+
          '</div>'+
          '<div class="jv-pills" style="justify-content:center">'+
            ...
            '<span class="jv-pill jv-transfer">⚡ 15% OFF transferencia</span>'+
          '</div>'+
          '<button type="button" class="jv-btn jv-cta" style="margin-top:16px">Quiero mi pack térmico</button>'+
        '</div>'+
      '</section>'+
      ...
      '<section class="jv-section jv-faq">'+
        ...
        faq("¿Qué incluye el pack?","Incluye 2 camisetas térmicas deportivas JAAV Art. 6000: 1 negra y 1 blanca.")+
        faq("¿Sirve para entrenar?","Sí. Es ideal como primera piel para entrenamientos al aire libre gracias a su tejido liviano, respirable y de secado rápido.")+
        faq("¿Abriga bien?","Sí. Su interior afelpado aporta suavidad extra y mayor retención del calor corporal.")+
        faq("¿Qué es Hidrowick®?","Es una tecnología que favorece la evaporación de la transpiración para mantenerte seco y cómodo por más tiempo.")+
        faq("¿Molesta o roza la piel?","No. Sus costuras planas ayudan a evitar roces o irritaciones.")+
        faq("¿Se deforma con los lavados?","Está diseñada para alta durabilidad: no se deforma con los lavados ni pierde sus propiedades con uso normal.")+
      '</section>'+

      '</div>'+

      '<div class="jv-sticky">'+
        '<img src="'+JAAV.heroImg+'" alt="Camiseta térmica JAAV">'+
        '<div class="jv-sticky-info"><strong>Pack x2 Camiseta térmica</strong><span>1 negra + 1 blanca</span></div>'+
  ...
  function limpiarDuplicados(){
    ...
    var c = document.querySelectorAll("#jaav-termica-css");
